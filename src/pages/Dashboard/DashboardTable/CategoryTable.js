...
function CategoryModal(props) {
    ...
    const handleCategorySubmit = async (e) => {
        ...
        try {
            ...
            await Axios.post(`${BASEURL}api/category/create-category`, formData, config)
                .then(data => {
...
function EditCategoryModal(props) {
    ...
    const handleCategorySubmit = async (e) => {
        ...
        try {
            ...
            await Axios.patch(`${BASEURL}api/category/edit-category`, formData, config)
                .then(data => {
                    if (data.data.errorcode === 0) {
                        toast.success(`${data.data.message}`, {
                            position: "bottom-center",
...
function DeleteCategoryModal(props) {
    ...
    const handleCategoryDelete = async () => {
        try {
            await Axios.delete(`${BASEURL}api/category/delete-category/${props.selected?._id}`)
                .then(data => {
                    if (data.data.errorcode === 0) {
                        toast.success(`${data.data.message}`, {
                            position: "bottom-center",
